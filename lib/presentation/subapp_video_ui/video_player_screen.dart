...
class _VideoPlayerScreenState extends ConsumerState<VideoPlayerScreen> {
  ...
  final List<double> _equalizerBands = List.filled(10, 0.0); // -12dB to +12dB
  ...
  Future<void> _loadHistorySettings() async {
     // Retrieve history to apply saved delays and tracks
                          ...
                          child: RotatedBox(
                            ...
                            child: Slider(
                              ...
                              onChanged: (v) {
                                ...
                                // MediaKit Equalizer logic
                                _player.setEqualizer(Equalizer(
                                  name: 'custom',
                                  bands: [EqualizerBand(_equalizerBands[index], 100.0)], // Simplified mapping for example
                                ));
                              },
                            ),
                          ),
        ...
        child: Column(
          ...
          children: [
            ...
            const ListTile(
              ...
              title: Text('Bedroom Speaker', style: TextStyle(color: Colors.white)),
              subtitle: Text('Available', style: TextStyle(color: Colors.green)),
            ),
            const SizedBox(height: 16),
          ...
          children: [
            ...
            if (_showControls) ...[
              ...
              Positioned(
                ...
                child: Column(
                  children: [
                    // StreamBuilder for real-time seek bar updates
